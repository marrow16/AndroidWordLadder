...
* Words are considered adjacent if changing one letter forms the other word.
...
| `DEBUSING` | `STINTIER` | `STINTIER` |
| `DEFUSING` | `STINGIER` | `STINGIER` |
| `REFUSING` | `SLINGIER` | `SLINGIER` |
| `RECUSING` | `SLANGIER` | `SLANGIER` |
| `RECULING` | `SLANTIER` | `SLANTIER` |
| `RECKLING` | `SCANTIER` | `SCANTIER` |
| `HECKLING` | `SCANTIES` | `SCANTIES` |
| `HACKLING` | `SHANTIES` | `SHANTIES` |
| `TACKLING` | `SHANNIES` | `SHANNIES` |
...
| `SHANNIES` | `TACKLING` | `TACKLING` |
| `SHANTIES` | `HACKLING` | `HACKLING` |
| `SCANTIES` | `HECKLING` | `HECKLING` |
| `SCANTIER` | `RECKLING` | `RECKLING` |
| `SLANTIER` | `RECULING` | `RECULING` |
| `SLANGIER` | `RECUSING` | `RECURING` |
| `SLINGIER` | `REFUSING` | `REPURING` |
| `STINGIER` | `DEFUSING` | `REPUTING` |
| `STINTIER` | `DEBUSING` | `DEPUTING` |
